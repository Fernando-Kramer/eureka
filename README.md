...
O **Eureka Service** é um microsserviço responsável pelo **registro e descoberta de serviços** dentro da arquitetura
de microsserviços da aplicação.
...
* Facilita a **escalabilidade horizontal** dos microsserviços;
...
2. Outros microsserviços (ex: `api-gateway`) são configurados como **clientes Eureka**;
...
|-----------------------|---------------------------------------------------|---------------------------------|
| `SERVER_PORT`         | Porta em que a aplicação será executada           | `8761`                          |
